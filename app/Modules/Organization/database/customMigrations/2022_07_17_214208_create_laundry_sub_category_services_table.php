...
class CreateLaundrySubCategoryServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('laundry_sub_category_services', function (Blueprint $table) {
            $table->id();
            $table->double('price');
    ...
    {
        Schema::dropIfExists('laundry_sub_category_services');
    }
}
