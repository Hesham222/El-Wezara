<?php
namespace Organization\Actions\VendorPrice;
use Illuminate\Http\Request;
use Carbon\Carbon;
use Organization\Models\VendorIngredient;

class VendorPriceFilterAction
{
    public function execute(Request $request)
    {
        return VendorIngredient::when($request->input('start_date') && $request->input('end_date'), function ($query) use ($request) {
