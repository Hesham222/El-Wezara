...
class FilterAction
{
    ...
    {
        return OrganizationAdmin::when($request->input('view') == 'trash', function ($query) use ($request) {
        ...
        ->select(['id','name', 'email', 'phone','role_id','deleted_by','deleted_at','created_by', 'created_at'])
