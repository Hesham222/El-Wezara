...
class FilterAction
{
    ...
    {
        return FreelanceTrainer::when($request->input('view') == 'trash', function ($query) use ($request) {
        ...
        ->select(['id','name','club_sport_id','phone','commission','note','attachment','national_id','deleted_by','deleted_at', 'created_at'])
