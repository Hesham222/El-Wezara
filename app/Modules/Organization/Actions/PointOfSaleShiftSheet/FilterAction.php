<?php
namespace Organization\Actions\PointOfSaleShiftSheet;
...
class FilterAction
{
    ...
    {
        return PointOfSaleOrderSheet::when($request->input('start_date') && $request->input('end_date'), function ($query) use ($request) {
