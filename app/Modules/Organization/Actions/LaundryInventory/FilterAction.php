<?php
namespace Organization\Actions\LaundryInventory;
...
class FilterAction
{
    ...
    {
        return LaundryInventory::when($request->input('view') == 'trash', function ($query) use ($request) {
            return $query->onlyTrashed();
        })
            ->select(['id','quantity','ingredient_id','laundry_id','created_at'])
