<?php
namespace Organization\Actions\classAndOutgoing;
...
class FilterAction
{
    ...
    {
        return IngredientCategory::whereBetween('created_at', [$request->input('date_from'), $request->input('date_to')])->with('JournalEntry')
        ->select(['id','journal_entry_id','created_at','updated_at'])
