...
class FilterAction_expected_revenues
{
    public function execute(Request $request)
    {
        return Reservation::when($request->input('view') == 'trash', function ($query) use ($request) {
            ...
            ->select(['id','contact_name','contact_phone','remaining_amount','booking_date','actual_price','paid_amount','event_type_id','created_at'])
