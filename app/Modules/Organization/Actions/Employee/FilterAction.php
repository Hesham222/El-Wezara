...
class FilterAction
{
    public function execute(Request $request)
    {
        ...
        ->select(['id','name', 'phone','department_id','employee_type_id','exemption_reason','leave_unpaid_status','training_description',
            'employee_job_id','date_of_hiring','approved','birth_date','insurance_number','social_status','military_status'
            ,'gross_salary','net_salary','national_id_end_date','health_certificate_end_date','contract_end_date',
