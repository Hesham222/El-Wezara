...
class FilterAction
{
    ...
    {
        return SubscriberAttendance::whereHas('Subscription',function ($query) use ($request){
        ...
        ->select(['id','subscriber_id','phone','training_id','train_time','attendance','deleted_by','deleted_at','created_at'])
