<?php
namespace Organization\Actions\PreparationAreaInventory;
...
use Organization\Models\PreparationAreaInventory;

class FilterAction
{
    public function execute(Request $request)
    {
        return PreparationAreaInventory::when($request->input('view') == 'trash', function ($query) use ($request) {
            return $query->onlyTrashed();
        })
            ->select(['id','quantity','ingredient_id','area_id','created_at'])
