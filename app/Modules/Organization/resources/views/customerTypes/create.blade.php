<x-organization::layout>
 <x-slot name="pageTitle">انواع العملاء | اضف</x-slot name="pageTitle">
 @section('customerTypes-active', 'm-menu__item--active m-menu__item--open')
 @section('customerTypes-create-active', 'm-menu__item--active')
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.customerType.store')}}" enctype="multipart/form-data"
                      ...
                      <div class="m-portlet__body">
                          ...
                          @include('Organization::customerTypes.components.information.table')
