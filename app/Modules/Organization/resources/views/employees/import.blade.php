<x-organization::layout>
    <x-slot name="pageTitle">الموظفين | اضافة</x-slot name="pageTitle">
    @section('employee-active', 'm-menu__item--active m-menu__item--open')
    @section('employee-import-active', 'm-menu__item--active')
    <x-slot name="style">
        <!-- Some styles -->
        <style>
            .invalid-feedback {
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.employee.storeImport')}}"
