            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.employee.store.job_description',$emp->id)}}"
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="">   رفع Job Description </label>
                                        <input
                                            multiple
                                            type="file"
                                            value="{{old('job_description_attachments')}}"
                                            name="job_description_attachments"
                                            class="form-control m-input"
                                            id="job_description_attachments"
                                        />
                                        @error('job_description_attachments')
