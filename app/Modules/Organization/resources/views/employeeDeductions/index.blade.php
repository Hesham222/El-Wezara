<x-organization::layout>
    ...
    @else
        ...
        @section('employeeDeduction-view-active', 'm-menu__item--active')
    @endif
        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title ">
                    @lang('Organization::organization.employeeDeduction')
                </h3>
            </div>
        </div>
    </div>
    ...
    <x-slot name="scripts">
        <script>
            $(function () {
                render("{!! route('organizations.employeeDeduction.data',['view' => request()->input('view',0)]) !!}");
                /**
                ...
                $('#searchButton').on('click', function (event) {
                    event.stopPropagation();
                    render("{!! route('organizations.employeeDeduction.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
                });
            });
        </script>
        <!-- external JS -->
