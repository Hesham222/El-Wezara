<x-organization::layout>
    <x-slot name="pageTitle">@lang('Organization::organization.employeeDeduction') | @lang('Organization::organization.create')</x-slot name="pageTitle">
    @section('employeeDeduction-active', 'm-menu__item--active m-menu__item--open')
    @section('employeeDeduction-create-active', 'm-menu__item--active')
    <x-slot name="style">
        <!-- Some styles -->
        <style>
            .invalid-feedback {
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.employeeDeduction.store')}}"
