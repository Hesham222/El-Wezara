<x-organization::layout>
 <x-slot name="pageTitle">المغاسل | اضف</x-slot name="pageTitle">
 @section('laundries-active', 'm-menu__item--active m-menu__item--open')
 @section('laundries-create-active', 'm-menu__item--active')
  <x-slot name="style">
  <!-- Some styles -->
    <style>
        .invalid-feedback {
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.laundry.store')}}" enctype="multipart/form-data"
                      ...
                      <div class="m-portlet__body">
                          <div class="form-group m-form__group row">
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <select name="head_id" required=""
                                          ...
                                          id="exampleSelect1">
                                      <option value="">--اختر رئيس للمغسله--</option>
                                  @foreach($employees as $employee)
                                          <option @if(old('head_id')== $employee->id) selected @endif
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <select name="employee_id[]" required="" multiple
                                          class="form-control m-input m-input--square selectpicker"
                                          id="exampleSelect1">
                                  @foreach($employees as $employee)
