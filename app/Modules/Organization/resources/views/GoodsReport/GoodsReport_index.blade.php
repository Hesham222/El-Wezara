<x-organization::layout>
  <x-slot name="pageTitle">تقارير بضاعه اخر المده اعداد وقيم  | عرض</x-slot name="pageTitle">
  @section('goodsReports-active', 'm-menu__item--active')
  @section('goodsReports-view-active', 'm-menu__item--active')
  <x-slot name="style">
    <!-- Some styles -->
  </x-slot>
    <!-- Start page content -->
        ...
        <div class="d-flex align-items-center">
          <div class="mr-auto">
            <h3 class="m-subheader__title ">
                تقارير بضاعه اخر المده اعداد وقيم
            </h3>
          </div>
        </div>
      </div>
        ...
        <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Organization::GoodsReport.components.GoodsReportFilterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('organizations.goodsReport.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('organizations.goodsReport.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
