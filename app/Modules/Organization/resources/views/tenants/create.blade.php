<x-organization::layout>
 <x-slot name="pageTitle">المستأجرين | اضف</x-slot name="pageTitle">
 @section('tenants-active', 'm-menu__item--active m-menu__item--open')
 @section('tenants-create-active', 'm-menu__item--active')
  <x-slot name="style">
  <!-- Some styles -->
    <style>
        .invalid-feedback {
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.tenant.store')}}" enctype="multipart/form-data"
