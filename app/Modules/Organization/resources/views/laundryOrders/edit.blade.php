<x-organization::layout>
 <x-slot name="pageTitle">طلبات المغاسل  | تعديل</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.laundryOrder.update', $record->id)}}"enctype="multipart/form-data"
                                              ...
                                              <td>
                                                  <select name="services[]" id="services" required=""
                                                      ...
                                                      @foreach($value->laundrySubCategory->laundrySubCategoryServices as $subCategoryService)
                                                          <option value="{{$subCategoryService->laundryService->id}}" @if($value->isServiceSelected($value->laundrySubCategory->id,$subCategoryService->laundryService->id,$record->id,$value->id)) selected @endif>{{$subCategoryService->laundryService->name}}</option>
                                                      @endforeach
                                                  </select>
                                              </td>
                                              <td>
