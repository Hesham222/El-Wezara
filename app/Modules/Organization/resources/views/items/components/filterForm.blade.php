<form  method="GET"  action="{{route('organizations.item.export')}}" id="filterDataForm">
 <input type="hidden" name="view" value="{{ request()->input('view',0)}}">
 <input type="hidden" name="subscription" value="{{ request()->input('subscription',0)}}">
   <div style="display: flex;justify-content: flex-end;align-items:flex-end;margin-bottom: 20px">
    <div class="input-group" style="width: 50%">
      <div class="input-group-prepend">
        <span class="input-group-text" id="">@lang('Organization::organization.from')</span>
      ...
      @endif
      <div class="input-group-prepend">
        <span class="input-group-text" id="">@lang('Organization::organization.to')</span>
      ...
      <div class="input-group-append">
        <select
          ...
          <option value="description">الوصف</option>
            ...
            <option value="type">@lang('Organization::organization.type')</option>
