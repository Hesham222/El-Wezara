...
{{--    </td>--}}
        ...
        <select
            ...
            @foreach($ingredients as $ingredient)
                <option
                    ...
                    value="{{$ingredient->id}}">
                    {{ $ingredient->getTranslation('name', 'ar')}} / {{ $ingredient->getTranslation('name', 'en')}} [{{$ingredient->quantity}} . {{$ingredient->unit_of_measurement?$ingredient->unit_of_measurement->name:'--'}}]
                </option>
            @endforeach
    ...
    <td>
        <input
            ...
            class="form-control"
            name="removable[]"
            value="@if($ingredients->first()){{$ingredients->first()->id.',Ingredient'}}@endif"
        >
    </td>
    <td class="show-variant" style="display: none">
        <input
            type="checkbox"
            class="form-control"
            name="variant[]"
