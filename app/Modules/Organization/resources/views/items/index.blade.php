...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">@lang('Organization::organization.items') | @lang('Organization::organization.trash')</x-slot name="pageTitle">
  @section('item-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">@lang('Organization::organization.items') | @lang('Organization::organization.view')</x-slot name="pageTitle">
  @section('item-view-active', 'm-menu__item--active')
@endif
        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
              <ul class="m-portlet__nav">
                  @if(checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),'Item-Add'))

                  <li class="m-portlet__nav-item">
                  <a href="{{route('organizations.item.create')}}"
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Organization::items.components.filterForm')
                    ...
                    <section class="content table-responsive">
                      <table id="data-table" class="table table-striped- table-bordered table-hover table-checkable" >
                          ...
                          <tr>
                              ...
                              <th>@lang('Organization::organization.type')</th>
                              <th>@lang('Organization::organization.image')</th>
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('organizations.item.data',['view' => request()->input('view',0),'subscription' => request()->input('subscription',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('organizations.item.data',['view' => request()->input('view',0),'subscription' => request()->input('subscription',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
