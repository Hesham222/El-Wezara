...
<html lang="en">
    <head>
    <meta charset="utf-8" />
    <title>Organization | {{ $pageTitle }}</title>
    <meta name="description" content="{{config('app.name')}} organization panel">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="shortcut icon" type="image/png" href="{{asset('plugins/portal/media/img/favicon.png')}}"/>

    <link rel="stylesheet" href="{{asset('plugins/portal/font-awesome.min.css')}}">

        <script src="{{asset('plugins/portal/webfont.js')}}"></script>
    <script src='{{asset('plugins/portal/a076d05399.js')}}' crossorigin='anonymous'></script>
    ...
    <link href="{!! asset('plugins/portal/vendors/base/vendors.bundle.rtl.css') !!}" rel="stylesheet" type="text/css" />
    <link href="{!! asset('plugins/portal/demo/default/base/style.bundle.rtl.css') !!}" rel="stylesheet" type="text/css" />
    <link href="{!! asset('plugins/portal/vendors/custom/datatables/datatables.bundle.css') !!}" rel="stylesheet" type="text/css" />
    <link href="{!! asset('plugins/portal/vendors/custom/fullcalendar/fullcalendar.bundle.rtl.css') !!}" rel="stylesheet" type="text/css" />
    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
        <x-organization::layout.header />
        <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
            <div class="m-grid__item m-grid__item--fluid m-wrapper">
                {{ $slot }}
            </div>
       </div>
        <x-organization::layout.sidebar />
        <footer class="m-grid__item m-footer ">
            <div class="m-container m-container--fluid m-container--full-height m-page__container">
                <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                    <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                        <span class="m-footer__copyright">
                             {{date('Y')}} &copy; {{--{{config('app.name')}}--}} بوابة الادارة {{--| طورت بواسطة--}}
                            {{--<a href="http://hypermedialabs.com/" target="_blank" class="m-link">HML</a>--}}
                        </span>
                    </div>
                </div>
            </div>
    ...
    <script src="{!! asset('plugins/portal/js/organization_js/admin_scripts.js') !!}" type="text/javascript"></script>
