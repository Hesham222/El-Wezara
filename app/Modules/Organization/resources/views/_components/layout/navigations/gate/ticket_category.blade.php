    ...
    <div class="col-xl-12">
        ...
        <div class="d-flex flex-wrap flex-row bd-highlight mb-3">
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'TicketCategory-Add'))
                <a href="{{ route('organizations.ticketCategory.create') }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'TicketCategory-View'))
                <a href="{{ route('organizations.ticketCategory.index') . '?view=view' }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                ...
                <a href="{{ route('organizations.ticketCategory.index') . '?view=trash' }}" class="menu_box">
                    <center>
