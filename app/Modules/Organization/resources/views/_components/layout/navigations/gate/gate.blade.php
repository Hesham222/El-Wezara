    ...
    <div class="col-xl-12">
        ...
        <div class="d-flex flex-wrap flex-row bd-highlight mb-3">
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'Gate-Add'))
                <a href="{{ route('organizations.gate.create') }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'Gate-View'))
                <a href="{{ route('organizations.gate.index') . '?view=view' }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'Gate-Delete'))
                <a href="{{ route('organizations.gate.index') . '?view=trash' }}" class="menu_box">
                    <center>
