...
<div class="row">
    <div class="col-xl-12">
        ...
        <div class="d-flex flex-wrap flex-row bd-highlight mb-3">
            ...
            <!-- Start Hotel Order Module -->

            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'HotelOrder-Add'))
                <a href="{{ route('organizations.hotelOrder.create') }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'HotelOrder-View'))
                <a href="{{ route('organizations.hotelOrder.index') . '?view=view' }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'HotelOrder-Delete'))
                <a href="{{ route('organizations.hotelOrder.index') . '?view=trash' }}" class="menu_box">
                    <center>
