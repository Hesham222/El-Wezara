    ...
    <div class="col-xl-12">
        ...
        <div class="d-flex flex-wrap flex-row bd-highlight mb-3">
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'MenuCategory-Add'))
                <a href="{{ route('organizations.menuCategory.create') }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'MenuCategory-View'))
                <a href="{{ route('organizations.menuCategory.index') . '?view=view' }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'MenuCategory-Delete'))
                <a href="{{ route('organizations.menuCategory.index') . '?view=trash' }}" class="menu_box">
                    <center>
