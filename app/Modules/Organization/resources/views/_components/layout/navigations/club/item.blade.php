    ...
    <div class="col-xl-12">
        ...
        <div class="d-flex flex-wrap flex-row bd-highlight mb-3">
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'Item-Add'))
                <a href="{{ route('organizations.item.create') }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'Item-View'))
                <a href="{{ route('organizations.item.index') . '?view=view' }}" class="menu_box">
                    <center>
            ...
            @if (checkOrganizationAdminPermission(auth('organization_admin')->user()->role->permissions->pluck('permission_id')->toArray(),
                'Item-Delete'))
                <a href="{{ route('organizations.item.index') . '?view=trash' }}" class="menu_box">
                    <center>
