<x-organization::layout>
 <x-slot name="pageTitle">انواع الموردين | اضف</x-slot name="pageTitle">
 @section('vendor-type-active', 'm-menu__item--active m-menu__item--open')
 @section('vendor-type-create-active', 'm-menu__item--active')
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.vendorType.store')}}" enctype="multipart/form-data"
                      ...
                      <div class="m-portlet__body">
                          ...
                          @include('Organization::vendorTypes.components.information.table')
    ...
    <x-slot name="scripts">
        ...
        <script>
            ...
            $(document).on('click','#new_pricing_row',function(){
                ...
                $.ajax({
                    url: "<?php echo e(route('organizations.vendorType.get.information.row')); ?>",
