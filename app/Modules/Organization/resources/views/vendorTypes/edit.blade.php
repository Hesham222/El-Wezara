<x-organization::layout>
    <x-slot name="pageTitle">انواع الموردين  | تعديل</x-slot name="pageTitle">
    @section('vendor-types-active', 'm-menu__item--active m-menu__item--open')
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.vendorType.update', $record->id)}}"
