<form  method="GET"  action="{{route('organizations.ticketPrice.export')}}" id="filterDataForm">
    ...
    <div class="input-group" style="width: 50%">
      ...
      <div class="input-group-append">
        <select
          ...
          <option value="category">الفئة الرئيسية</option>
          <option value="subCategory">الفئة</option>
