<form  method="GET"  action="{{route('organizations.laundrySubCategory.export')}}" id="filterDataForm">
<input type="hidden" name="view" value="{{ request()->input('view',0)}}">
  <div style="display: flex;justify-content: flex-end;align-items:flex-end;margin-bottom: 20px">
      ...
      <div class="input-group-append">
          <select name="parentCol" id="parentCol" required="" class="form-control m-input m-input--square" >
              <option value="">--اختر  فئه--</option>
          ...
          <option value="name">الاسم</option>
            <option value="parent">الفرع الرئيسي</option>
