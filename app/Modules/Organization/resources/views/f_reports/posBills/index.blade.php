<x-organization::layout>
    <x-slot name="pageTitle">نقاط البيع | عرض</x-slot name="pageTitle">
    @section('bills-active', 'm-menu__item--active m-menu__item--open')
    @section('posBills-report-active', 'm-menu__item--active')
    <x-slot name="style">
        <!-- Some styles -->
    </x-slot>
    <!-- Start page content -->
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                <section class="content">
                    @include('Organization::f_reports.posBills.filterForm')
...
<input type="hidden" name="invoiceType" value="OrderPayment">
    ...
    <x-slot name="scripts">
        <script>
            $(function () {
                render("{!! route('organizations.report.posBills.data',['view' => request()->input('view',0)]) !!}");
                /**
                ...
                $('#searchButton').on('click', function (event) {
                    event.stopPropagation();
                    render("{!! route('organizations.report.posBills.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
                });
            });
