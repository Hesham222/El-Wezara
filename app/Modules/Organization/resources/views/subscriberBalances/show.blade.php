<x-organization::layout>
  ...
  <x-slot name="pageTitle">الأشتراكات | عرض</x-slot name="pageTitle">
  @section('subscriberBalances-view-active', 'm-menu__item--active')

@section('subscriberBalances-active', 'm-menu__item--active m-menu__item--open')
                          ...
                          @if(count($records))
                              @foreach($records as $record)
                                  ...
                                  <tr id="tableRecord-{{$record->id}}">
                                      ...
                                      <td>{{$record->paid_date?$record->paid_date:"لا يوجد"}}</td>
                                  </tr>
