<x-organization::layout>
    <x-slot name="pageTitle">@lang('Organization::organization.employeeVacationType') | @lang('Organization::organization.edit')</x-slot name="pageTitle">
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.employeeVacationType.update', $record->id)}}"
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select name="vacation_type" required="" class="form-control m-input m-input--square" id="exampleSelect1">
                                            ...
                                            <option @if(old('vacation_type') == 'Paid') selected @endif @if($record->vacation_type == 'Paid') selected @endif >Paid</option>
                                            <option @if(old('vacation_type') == 'UnPaid') selected @endif @if($record->vacation_type == 'UnPaid') selected @endif >UnPaid</option>
                                        </select>
                                        @error('vacation_type')
                                        <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
