<x-organization::layout>
 <x-slot name="pageTitle">طلبات منطقه التحضير   | تعديل</x-slot name="pageTitle">
                          ...
                          <div class="m-form__actions m-form__actions--solid">
                              <div class="row">
                                  ...
                                  <div class="col-lg-6 m--align-right">
                                      <a href="{{route('organizations.PreparationAreaOrder.index')}}" class="btn btn-sm btn-primary">
                                          العوده للطلبات
                                      </a>
                                  </div>
                              </div>
