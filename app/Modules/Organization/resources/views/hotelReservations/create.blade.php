<x-organization::layout>
    <x-slot name="pageTitle">حجوزات الفنادق | اضف</x-slot name="pageTitle">
    @section('hotelReservations-active', 'm-menu__item--active m-menu__item--open')
    @section('hotelReservations-create-active', 'm-menu__item--active')
    @include('Organization::hotelReservations.components.addNewCustomer')
    <x-slot name="style">
        <!-- Some styles -->
        <style>
            .invalid-feedback {
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.hotelReservation.store')}}" enctype="multipart/form-data"
                              class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                            @csrf
                            <div class="m-portlet__body">
                                <div>
                                    <div id="CustomerRoom" class="form-group m-form__group row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select name="customer_id" required=""
                                                    id="customer_id" class="form-control m-input m-input--square selectpicker"
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select name="supplier" class="form-control m-input m-input--square">
                                                ...
                                                @foreach($suppliers as $supplier)
                                                    <option @if(old('supplier') == $supplier->id) selected @endif value="{{ $supplier->id }}">{{ $supplier->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('supplier')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group m-form__group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input class="form-control" type="date" name="arrival_date" id="arrival_date" value="{{ old('arrival_date') }}" required>
                                            @error('arrival_date')
                                            <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                                ...
                                <div id="TotalPrice" class="form-group m-form__group row">
