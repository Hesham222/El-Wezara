<x-organization::layout>
 <x-slot name="pageTitle">مناطق التحضير | اضف</x-slot name="pageTitle">
 @section('preparationAreas-active', 'm-menu__item--active m-menu__item--open')
 @section('preparationAreas-create-active', 'm-menu__item--active')
  <x-slot name="style">
  <!-- Some styles -->
    <style>
        .invalid-feedback {
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.preparationArea.store')}}" enctype="multipart/form-data"
                      ...
                      <div class="m-portlet__body">
                          ...
                          <div class="form-group m-form__group row">
                              ...
                              <div class="col-lg-6">
                                  <label>هل المنطقة تصنع مكونات ؟  :</label>
                                  <input
                                      type="checkbox"
                                      name="hasManufactured"
                                      class="form-control m-input"
                                     />
                                  @error('hasManufactured')
                                  <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                                  @enderror
