            ...
            <td>
                @if(request()->query('view')=='trash')
                    <a
                        ...
                        onclick="injectModalData('{{$record->id}}', '{{route('organizations.laundryHotelOrder.restore')}}', 'confirm-password-form', 'POST')"
                    >
                    ...
                    <a
                        ...
                        data-toggle="modal"
                        data-target="#confirm-password-modal"
                        onclick="injectModalData('{{$record->id}}', '{{route('organizations.laundryHotelOrder.destroy', $record->id)}}', 'confirm-password-form', 'DELETE')"
                    >
...
{{--                    <a--}}
{{--                        href="{{route('organizations.laundryIskanOrder.details',$record->id)}}"--}}
{{--                        title="عرض التفاصيل"--}}
{{--                        class="btn btn-sm btn-primary">--}}
...
{{--                    </a>--}}
                    <a
                        href="{{route('organizations.laundryHotelOrder.edit',$record->id)}}"
                        title="تعديل"
                        class="btn btn-sm btn-primary">
