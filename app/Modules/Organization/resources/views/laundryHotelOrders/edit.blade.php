<x-organization::layout>
 <x-slot name="pageTitle">طلبات اسكان  | تعديل</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.laundryHotelOrder.update', $record->id)}}"enctype="multipart/form-data"
                      ...
                      <div class="m-portlet__body">
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <select name="hotels" id="hotels" required="" class="form-control hotels">
                                      ...
                                      @foreach($hotels as $hotel)
                                          <option @if(old('hotels')== $hotel->id || $hotel->id == $record->hotel_id) selected @endif
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <select name="rooms" id="rooms" required="" class="form-control rooms">
                                      ...
                                      @foreach($rooms as $room)
                                          <option @if(old('rooms')== $room->id || $room->id == $record->room_id) selected @endif
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <select name="laundry_id" id="laundry_id" required="" class="form-control hotels">
                                      ...
                                      @foreach($laundries as $laundry)
                                          <option @if(old('laundry_id')== $laundry->id || $laundry->id == $record->laundry_id) selected @endif
                          ...
                          <div class="form-group m-form__group row">
                              ...
                              <div class="col-lg-6">
                                  <label>الوقت:</label>
                                  <input class="form-control date" type="time" name="time" id="time"
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-12">
                                  ...
                                  <table  width="100%" class="table table-striped- table-bordered table-hover table-checkable" id="categories-table">
                                      ...
                                      <tbody>
                                      @foreach($record->laundryOrderServices as $value)
                                              ...
                                              <td>
                                                  <select name="categories[]" id="categories" required=""
                                                      ...
                                                      @foreach($categories as $category)
                                                          <option @if($value->laundryCategory->id === $category->id) selected @endif
                                              ...
                                              <td>
                                                  <select name="services[]" id="services" required=""
                                                      ...
                                                      @foreach($value->laundrySubCategory->laundrySubCategoryServices as $subCategoryService)
                                                          <option value="{{$subCategoryService->laundryService->id}}" @if($value->isServiceSelected($value->laundryCategory->id,$value->laundrySubCategory->id,$subCategoryService->laundryService->id,$record->id,$value->id)) selected @endif>{{$subCategoryService->laundryService->name}}</option>
                                                      @endforeach
                                                  </select>
                                              </td>
                                              <td>
