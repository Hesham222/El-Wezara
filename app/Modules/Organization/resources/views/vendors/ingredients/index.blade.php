<x-organization::layout>
    @if(request()->input('view')=='ingredient')
...
{{--                      <i class="la la-plus">--}}
{{--                      </i>--}}
{{--                      <span>@lang('Organization::organization.vendor') @lang('Organization::organization.new')</span>--}}
{{--                    </span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        @endif--}}
            ...
            <div class="m-portlet__body">
                <section class="content">
                    @include('Organization::vendors.ingredients.components.filterForm')
    ...
    <x-slot name="scripts">
        <script>
            $(function () {
                render("{!! route('organizations.vendor.ingredientData',['view' => request()->input('ingredient',0),'record_id'=>$record->id]) !!}");
                /**
                ...
                $('#searchButton').on('click', function (event) {
                    event.stopPropagation();
                    render("{!! route('organizations.vendor.ingredientData',['view' => request()->input('view',0),'record_id'=>$record->id]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val()+ '&ingredient=' + $('#ingredientColumn').val());
                });
            });
        </script>
        <!-- external JS -->
