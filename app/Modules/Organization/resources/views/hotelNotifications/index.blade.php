<x-organization::layout>
 <x-slot name="pageTitle">  اشعارات الفنادق</x-slot name="pageTitle">
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title"> كل :{{ $all_hotelOrders }} | جديد :{{  $last_two_days_hotelOrders }}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-footer ">
                                                <a href="{{ route('organizations.hotelOrder.index') }}">
                                                    <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                            class="fa fa-calendar-o"></i>    اوردرات الفنادق
                                                    </div>
                                                </a>
                                            </div>
                                        </a>
