<x-organization::layout>
    <x-slot name="pageTitle">الشكاوى  | تعديل</x-slot name="pageTitle">
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.complain.update', $record->id)}}"
