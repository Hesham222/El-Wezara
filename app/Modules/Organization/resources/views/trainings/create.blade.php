<x-organization::layout>
 <x-slot name="pageTitle">التدريبات | اضف</x-slot name="pageTitle">
 @section('trainings-active', 'm-menu__item--active m-menu__item--open')
 @section('trainings-create-active', 'm-menu__item--active')
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.training.store')}}" enctype="multipart/form-data"
                      ...
                      <div class="m-portlet__body">
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <select name="club_sport_id" id="club_sport_id" required=""
                                          class="form-control m-input m-input--square selectpicker"
                                          id="exampleSelect1">
                                      <option value="">--اختر رياضه النادي--</option>
                          ...
                          <div class="form-group m-form__group row">
                              ...
                              <div class="col-lg-6">
                                  <label>النوع:</label>
                                  <select id="audience_type" name="type" required="" class="form-control m-input m-input--square" >
                          ...
                          @include('Organization::trainings.components.schedule.table')
                          @include('Organization::trainings.components.pricing.table')
                      </div>
