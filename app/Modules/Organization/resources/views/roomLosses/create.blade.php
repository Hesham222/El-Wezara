<x-organization::layout>
 ...
 @section('losses-create-active', 'm-menu__item--active')
  <x-slot name="style">
  <!-- Some styles -->
    <style>
        .invalid-feedback {
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.roomLoss.store')}}"
                      ...
                      <div class="m-portlet__body">
                          <div class="form-group m-form__group row">
                              ...
                              <div class="col-lg-4">
                                  ...
                                  <select id="rooms-list" name="room" class="form-control" required="" ></select>
                                  @error('room')
                              ...
                              <div class="col-lg-4">
                                  ...
                                  <input type="date" name="request_date" id="startDateCol" class="form-control" required>
