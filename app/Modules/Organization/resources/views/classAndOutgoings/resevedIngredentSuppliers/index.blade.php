<x-organization::layout>
  <x-slot name="pageTitle">تقارير الصنف والمنصرف    | عرض</x-slot name="pageTitle">
        ...
        <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Organization::classAndOutgoings.resevedIngredentSuppliers.components.filterForm')
                    ...
                    <section class="content table-responsive">
                      <table id="data-table" class="table table-striped- table-bordered table-hover table-checkable" >
                          ...
                          <tr>
                              ...
                              <th>اسم المكون</th>
                              <th>المنصرف</th>
                              <th>رصيد اخر المده</th>
                              <th> قيمه رصيد اخر المده</th>
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('organizations.classAndOutgoing.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('organizations.classAndOutgoing.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
