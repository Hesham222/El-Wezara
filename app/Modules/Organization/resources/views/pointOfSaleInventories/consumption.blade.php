          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.PointOfSaleInventory.save')}}"enctype="multipart/form-data"
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <input
                                      ...
                                      name="PointOfSale"
                                      id="PointOfSale"
                                      value="{{old('PointOfSale')?old('PointOfSale'):$record->PointOfSale->name}}"
                                      required=""
