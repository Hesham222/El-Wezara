<x-organization::layout>
  ...
  <x-slot name="pageTitle">اعاده طلب  | سله المهملات</x-slot name="pageTitle">
  @section('laundryOrders-return-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">اعاده طلب | عرض</x-slot name="pageTitle">
  @section('laundryOrders-return-view-active', 'm-menu__item--active')
@endif
@section('laundryOrders-return-active', 'm-menu__item--active m-menu__item--open')
