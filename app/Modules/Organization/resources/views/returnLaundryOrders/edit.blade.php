<x-organization::layout>
 <x-slot name="pageTitle">اعاده طلب  | تعديل</x-slot name="pageTitle">
                                          ...
                                          <tr class="nearest-service">
                                              ...
                                              <td>
                                                  <select name="subCategories[]" id="subCategories" required=""
                                                      ...
                                                      <option value="{{$value->laundrySubCategory->id}}" selected>{{$value->laundrySubCategory->name}}</option>
                                              ...
                                              <td>
                                                  <select name="services[]" id="services" required=""
                                                      ...
                                                      @foreach($value->laundrySubCategory->laundrySubCategoryServices as $service)
                                                          <option value="{{$service->laundryService->id}}">{{$service->laundryService->name}}</option>
                                                      @endforeach
                                                  </select>
                                              </td>
                                              <td>
