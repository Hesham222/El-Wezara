<x-organization::layout>
  ...
  <x-slot name="pageTitle">الموردين  | سله المهملات</x-slot name="pageTitle">
  @section('suppliers-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">الموردين | عرض</x-slot name="pageTitle">
  @section('suppliers-view-active', 'm-menu__item--active')
@endif
@section('suppliers-active', 'm-menu__item--active m-menu__item--open')
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-tools">
              <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                  <a href="{{route('organizations.supplier.create')}}"
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Organization::suppliers.components.filterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('organizations.supplier.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('organizations.supplier.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
