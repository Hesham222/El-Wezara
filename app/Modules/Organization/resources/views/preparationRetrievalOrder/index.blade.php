<x-organization::layout>
    ...
    @else
        <x-slot name="pageTitle">مناطق التحضير | طلبات الارجاع</x-slot name="pageTitle">
                    ...
                    <div class="table-responsive">
                        <section class="content table-responsive">
                            <table id="data-table" class="table table-striped- table-bordered table-hover table-checkable" >
                                ...
                                <tr>
                                    <th>التعريف</th>
                                    <th>الطلب من منطقة </th>
                                    <th> الطلب الى منطقة / الكخزن الرئيسى</th>
                                    <th>المكونات</th>
                                    <th>الحالة</th>
                                    <th>نشأ في</th>
                                    <th> اجراءات</th>
                                ...
                                @if (count($orders))
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>@if($order->resever){{$order->resever->name}}@else المخزة الرئيسى @endif</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('organizations.preparationArea.approve.retrieval.order',$order->id)}}" class="btn btn-sm btn-success">
                                                    قبول الاسترجاع
                                                </a>

                                                <a href="{{route('organizations.preparationArea.cancel.retrieval.order',$order->id)}}" class="btn btn-sm btn-danger">
                                                    رفض الاسترجاع
                                                </a>
                                                @else
                                                    ---
