<x-organization::layout>
  ...
  @section('trainingReports-view-active', 'm-menu__item--active')

@section('trainingReports-active', 'm-menu__item--active m-menu__item--open')
                          ...
                          @if(count($records))
                              @foreach($records as $record)
                                  ...
                                  <tr id="tableRecord-{{$record->id}}">
                                      ...
                                      <td>{{$record->Subscriber?$record->Subscriber->phone:"لا يوجد"}}</td>
                                  </tr>
