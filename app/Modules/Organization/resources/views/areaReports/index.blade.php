<x-organization::layout>
  <x-slot name="pageTitle">تقرير المناطق | عرض</x-slot name="pageTitle">
    @section('sport-reports-active', 'm-menu__item--active m-menu__item--open')
    @section('areaReports-view-active', 'm-menu__item--active')
        ...
        <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Organization::areaReports.components.filterForm')
                    ...
                    <section class="content table-responsive">
                      <table id="data-table" class="table table-striped- table-bordered table-hover table-checkable" >
                          ...
                          <tr>
                              ...
                              <th>اسم المنطقه</th>
                              <th>اسم التدريب </th>
                              <th>وقت بدايه التدريب</th>
                              <th>وقت انتهاء التدريب</th>
                          </tr>
                          </thead>
                          <tbody id="spinner">
                            <tr>
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('organizations.areaReport.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('organizations.areaReport.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val()+'&day=' + $('#dayCol').val());
        });
    });
  </script>
</x-slot>
