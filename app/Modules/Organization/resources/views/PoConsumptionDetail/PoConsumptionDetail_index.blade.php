<x-organization::layout>
  <x-slot name="pageTitle">استهلاك نقطه بيع تفصيليا | عرض</x-slot name="pageTitle">
  @section('PoConsumptions-active', 'm-menu__item--active')
  @section('PoConsumptions-view-active', 'm-menu__item--active')
    @section('PoConsumptions-active', 'm-menu__item--active m-menu__item--open')
        ...
        <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Organization::PoConsumptionDetail.components.PoConsumptionDetailFilterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('organizations.PoConsumptionDetail.data',['id'=>$record->id,'view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('organizations.PoConsumptionDetail.data',['id'=>$record->id,'view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
