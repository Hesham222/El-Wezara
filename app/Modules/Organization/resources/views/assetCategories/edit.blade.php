<x-organization::layout>
 <x-slot name="pageTitle">فئة الأصول  | تعديل</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('organizations.assetCategory.update', $record->id)}}"enctype="multipart/form-data"
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <input
                                      type="number"
                                      step="0.01"
                                      value="{{old('percentage')?old('percentage'):$record->percentage}}"
                                      name="percentage"
                                      id="percentage"
                                      required=""
                                      class="form-control m-input"
