<x-organization::layout>
    <x-slot name="pageTitle">@lang('Organization::organization.unit') | @lang('Organization::organization.edit')</x-slot name="pageTitle">
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.unit.update', $record->id)}}"
