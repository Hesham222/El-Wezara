<x-organization::layout>
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                <section class="content">
                    @include('Organization::ingredients.components.execIndexfilterForm')
                        ...
                        <section class="content table-responsive">
                            <table id="data-table" class="table table-striped- table-bordered table-hover table-checkable" >
                                ...
                                <tr>
                                    ...
                                    <th>اسم المكون العربى</th>
                                    <th>اسم المكون الانجليزى</th>
                                    <th>الكمية</th>
                                    <th>تاريخ انتهاء الصلاحية</th>
                                    <th>القائم بالموافقة على مذكرة الاعدام</th>
                                    <th>انشاء فى </th>
                                </tr>
                                </thead>
                                <tbody id="spinner">
    ...
    <x-slot name="scripts">
        <script>
            $(function () {
                render("{!! route('organizations.ingredient.execIndex.data',['view' => request()->input('view',0)]) !!}");
                /**
                ...
                $('#searchButton').on('click', function (event) {
                    event.stopPropagation();
                    render("{!! route('organizations.ingredient.execIndex.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
                });
