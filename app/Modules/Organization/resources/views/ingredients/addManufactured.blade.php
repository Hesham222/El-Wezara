<x-organization::layout>
    <x-slot name="pageTitle">@lang('Organization::organization.ingredients') | @lang('Organization::organization.create')</x-slot name="pageTitle">
    @section('ingredient-active', 'm-menu__item--active m-menu__item--open')
    @section('ingredient-create-active', 'm-menu__item--active')
    <x-slot name="style">
        <!-- Some styles -->
        <style>
            .invalid-feedback {
            ...
            <div class="m-portlet__body">
                <div class="table-responsive">
                    <section class="content">
                        <form method="POST" action="{{route('organizations.ingredient.store')}}"
                              class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                            @csrf
                            <input type="hidden" value="{{$record->id}}" name="ing_id" />
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input
                                            type="number"
                                            value="{{old('re_order_quantity')?old('re_order_quantity'):0}}"
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select name="unit" required=""
                                                ...
                                                id="exampleSelect1">
                                                <option selected value="{{$record->unit_of_measurement->id}}">{{$record->unit_of_measurement->getTranslation('name', 'ar')}}  / {{$record->unit_of_measurement->getTranslation('name', 'en')}}
                                                </option>
...
{{--                                            <option @if(old('type') == 'laundry') selected @endif value="laundry" >Laundry</option>--}}
{{--                                            <option @if(old('type') == 'hotel') selected @endif value="hotel" >Hotel</option>--}}
{{--                                            <option @if(old('type') == 'pointOfSale') selected @endif value="pointOfSale" >Point Of Sale</option>--}}
{{--                                            <option @if(old('type') == 'preprationArea') selected @endif value="preprationArea" >Prepration Area</option>--}}
{{--                                            <option @if(old('type') == 'all') selected @endif value="all" >All</option>--}}
{{--                                        </select>--}}
{{--                                        @error('type')--}}
{{--                                        <span class="invalid-feedback" role="alert">--}}
{{--                                          <strong>{{ $message }}</strong>--}}
