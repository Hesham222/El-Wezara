                                ...
                                <div class="form-group m-form__group row">
                                            ...
                                            <select name="unit" required=""
                                                ...
                                                @foreach($units as $unit)
                                                    <option @if(old( 'unit')==$unit->id ) selected
                                                            @endif value="{{$unit->id}}">{{$unit->getTranslation('name', 'ar')}}  / {{$unit->getTranslation('name', 'en')}}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('unit')
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select name="type" required="" class="form-control m-input m-input--square" id="exampleSelect1">
                                            ...
                                            <option @if(old('type') == 'laundry') selected @endif value="laundry" >مغسلة</option>
                                            <option @if(old('type') == 'hotel') selected @endif value="hotel" >فندق</option>
                                            <option @if(old('type') == 'pointOfSale') selected @endif value="pointOfSale" >نقطة بيع</option>
                                            <option @if(old('type') == 'preprationArea') selected @endif value="preprationArea" >منطقة تحضير</option>
                                            <option @if(old('type') == 'all') selected @endif value="all" >الجميع</option>
                                        </select>
                                        @error('type')
                                        <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
