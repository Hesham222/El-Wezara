                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title"> {{$stats['club_number']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-footer ">
                                                <a href="#">
                                                    <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                            class="fa fa-calendar-o"></i>عدد الانديه
                                                    </div>
                                                </a>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card card-stats" style="background-color: black;">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_emps']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer ">
                                            <div class="stats" style="font-weight: bold;"><i
                                                    class="fa fa-calendar-o"></i>عدد الموظفين
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title"> {{$stats['all_cermonies']}} </p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <a href="#">
                                                    ...
                                                    <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                            class="fa fa-calendar-o"></i>عدد الحفالات
                                                    </div>
                                                </a>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card card-stats" style="background-color: black;">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_collected_amount']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer ">
                                            <div class="stats" style="font-weight: bold;"><i
                                                    class="fa fa-calendar-o"></i> المبالغ المجمعه
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_reseved_amount']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                ...
                                                <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                        class="fa fa-calendar-o"></i>المستحق دفعه
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title"> {{$stats['all_trainings']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_trainers']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-stats" style="background-color: black;">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['trannigns_amount']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                        class="fa fa-calendar-o"></i>اشتراكات مدي الحياه المجمعه
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_subs']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_active_subs']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                        class="fa fa-calendar-o"></i>الاشتراكات المستحقة
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title"> {{$stats['all_items']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <a href="#">
                                                    <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                            class="fa fa-calendar-o"></i> عدد المنتجات
                                                    </div>
                                                </a>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card card-stats" style="background-color: black;">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['inventory_amount']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer ">
                                            <div class="stats" style="font-weight: bold;"><i
                                                    class="fa fa-calendar-o"></i> قيمة المخزون
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_vendors']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title"> {{$stats['all_rent_areas']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <a href="#">
                                                    <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                            class="fa fa-calendar-o"></i>عدد المساحات القابلة للتأجير
                                                    </div>
                                                </a>
                                            </div>
                                        </a>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <div class="card card-stats">
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                        class="fa fa-calendar-o"></i> عقود نشطة
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card card-stats" style="background-color: black;">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_contracts_amount']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer ">
                                            <div class="stats" style="font-weight: bold;"><i
                                                    class="fa fa-calendar-o"></i> المجمع من الإيجار مدى الحياة
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_active_renters']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_monthly_amount_rents']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                        class="fa fa-calendar-o"></i> القيمة الشهرية للعقود المؤجرة
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title"> {{$stats['all_gates']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <a href="#">
                                                    <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                            class="fa fa-calendar-o"></i>عدد البوابات
                                                    </div>
                                                </a>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card card-stats" style="background-color: black;">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_gates_amount']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer ">
                                            <div class="stats" style="font-weight: bold;"><i
                                                    class="fa fa-calendar-o"></i> ربح البوابات
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers">
                                                        <p class="card-title">{{$stats['all_tickets']}}</p>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#">
                                            <div class="card-footer ">
                                                <div class="stats" style="color:#fff;font-weight: bold;"><i
                                                        class="fa fa-calendar-o"></i> عدد التذاكر
                                                </div>
                                            </div>
                                        </a>
                                    </div>
