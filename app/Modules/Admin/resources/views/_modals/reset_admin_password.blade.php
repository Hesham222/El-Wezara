    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">تغير كلمة مرور المشرف</h4>
                ...
                <form class="" id="reset-admin-password-form" method="post" action="#">
                    ...
                    <div class="form-group">
                        <label for="inputAdminPassword">
                            كلمة المرور الحالية<span style="color:red">*</span>
                        </label>
                        <input 
                            type="password" 
                            name="admin_password" 
                    ...
                    <div class="form-group">
                        <label for="inputPass">
                            كلمة المرور الجديدة<span style="color:red">*</span>
                        </label>
                        <input 
                            type="password" 
                            name="password" 
                    ...
                    <div class="form-group">
                        <label for="inputConfirmPass">
                            تأكيد كلمة المرور الجديدة<span style="color:red">*</span>
                        </label>
                        <input 
                            type="password" 
